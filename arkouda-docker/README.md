...
```
# set env variables
export CHAPEL_SMP_IMAGE=bearsrus/chapel-gasnet-smp:1.31.0
export ARKOUDA_BRANCH_NAME=2023.06.20
export ARKOUDA_DISTRO_NAME=v2023.06.20
export ARKOUDA_DOWNLOAD_URL=https://github.com/Bears-R-Us/arkouda/archive/refs/tags/v2023.06.20.zip
...
# set env variables
export ARKOUDA_IMAGE_REPO=bearsrus
export ARKOUDA_VERSION=v2023.06.20
...
```
export CHAPEL_UDP_IMAGE=bearsrus/chapel-gasnet-udp:1.31.0
export ARKOUDA_DISTRO_NAME=v2023.06.20
export ARKOUDA_DOWNLOAD_URL=https://github.com/Bears-R-Us/arkouda/archive/refs/tags/v2023.06.20.zip
export ARKOUDA_BRANCH_NAME=2023.06.20
...
```
export EXPORTER_VERSION=v2023.06.20
export ARKOUDA_DISTRO_NAME=v2023.06.20
export ARKOUDA_BRANCH_NAME=2023.06.20
export ARKOUDA_DOWNLOAD_URL=https://github.com/Bears-R-Us/arkouda/archive/refs/tags/v2023.06.20.zip
...
docker run -it --rm -v $PWD/src:/opt/arkouda/src bearsrus/arkouda-smp-developer:v2023.06.20 
```
...
```
python build_docker_image.py --arkouda_tag=v2023.06.20 --chapel_version=1.31.0 --image_type=arkouda-full-stack
```

### chapel-gasnet-smp

```
python build_docker_image.py --chapel_version=1.31.0 --image_type=chapel-gasnet-smp
```

### arkouda-smp-server

```
python build_docker_image.py --arkouda_tag=v2023.06.20 --chapel_version=1.31.0 --image_type=arkouda-smp-server
```

### chapel-gasnet-udp

```
python build_docker_image.py --chapel_version=1.31.0 --image_type=chapel-gasnet-udp
```

### arkouda-udp-server

```
python build_docker_image.py --arkouda_tag=v2023.06.20 --chapel_version=1.31.0 --image_type=arkouda-udp-server
```

### prometheus-arkouda-exporter

```
python build_docker_image.py --arkouda_tag=v2023.06.20 --image_type=prometheus-arkouda-exporter
```

### arkouda-smp-developer

```
python build_docker_image.py --arkouda_tag=v2023.06.20 --chapel_version=1.31.0 --image_type=arkouda-smp-developer
```
